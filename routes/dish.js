...
import { addDish, addProduct, deleteDish, editDish, editProduct, getAllDish, getDish, removeProduct } from '../controllers/dishController.js'
...
export default Router()
    ...
    .put('/editProd/:id', auth, editProduct)
