...
import { secret, apiURL, serverURL, googleClient, googleSecret } from './keys.js'
...
//         {
//             clientID: facebookClientPrivate,
...
export default async (app) => {
    app
        ...
        // .get('/auth/facebook', passport.authenticate('google', { scope: ['profile', 'email'], session: false }))
        // .get('/auth/facebook/callback', passport.authenticate('google', { failureRedirect: '/', session: false }),
        //     (_, res) => res.status(200).json(res.req.user))
}